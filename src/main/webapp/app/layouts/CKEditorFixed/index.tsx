...
class CKEditorFixed extends React.PureComponent<ICreateContentProps, ICreateContentState> {
  constructor(props) {
    super(props);
  }
...
export default connect(mapStateToProps, mapDispatchToProps)(CKEditorFixed);

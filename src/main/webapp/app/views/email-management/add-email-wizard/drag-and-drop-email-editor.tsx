...
interface IDragAndDropEmailEditorProps extends StateProps, DispatchProps, RouteComponentProps<{ id: any; idTemplate: any }> {}
interface IDragAndDropEmailEditorState {
...
class DragAndDropEmailEditor extends React.Component<IDragAndDropEmailEditorProps, IDragAndDropEmailEditorState> {
  state: IDragAndDropEmailEditorState = {
...
export default connect(mapStateToProps, mapDispatchToProps)(DragAndDropEmailEditor);

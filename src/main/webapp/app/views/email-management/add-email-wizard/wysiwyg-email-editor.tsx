...
interface IWysiwygEmailEditorProps extends StateProps, DispatchProps, RouteComponentProps<{ id: any; idTemplate: any }> {}
interface IWysiwygEmailEditorState {
...
class WysiwygEmailEditor extends React.Component<IWysiwygEmailEditorProps, IWysiwygEmailEditorState> {
  state: IWysiwygEmailEditorState = {
...
export default connect(mapStateToProps, mapDispatchToProps)(WysiwygEmailEditor);

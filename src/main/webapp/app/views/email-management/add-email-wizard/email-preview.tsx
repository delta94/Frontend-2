...
export interface IEmailPreviewProps extends StateProps, DispatchProps {}
...
interface IEmailPreviewState {
  styleForDOM?: string;
  scriptDOM?: string;
  showMobile: boolean;
}

class EmailPreview extends React.PureComponent<IEmailPreviewProps, IEmailPreviewState> {
  constructor(props) {
    super(props);
  }

  state: IEmailPreviewState = {
    styleForDOM: '',

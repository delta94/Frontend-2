    ...
    return (
      <Modal className="modal-info-title" isOpen={isOpenModal}>
        <ModalHeader toggle={this.toggle}>
          <Translate contentKey="config-info.new-campaign" />
        </ModalHeader>
        <ModalBody>
          <Row>
            <Row>
              <Col span={5}>
                <label className="label-message">
                  <Translate contentKey="config-info.name-campaign" />
                </label>
              </Col>
              <Col span={18}>
                <Input
                  defaultValue={
                    listInfoCampaing.name ? listInfoCampaing.name : list_clone_version.name ? list_clone_version.name : 'Tạo chiến dịch mới'
                  }
            ...
            <Row>
              ...
              <Col span={18}>
                <CampaignTag
                  defaultValue={
                    listInfoCampaing.tag && listInfoCampaing.tag.length > 0
                      ? listInfoCampaing.tag
            ...
            <Row>
              <Col span={6}>
                <label className="label-message">
                  <Translate contentKey="config-info.descrition" />
                </label>
              </Col>
              <Col span={18}>
                <TextArea
                  defaultValue={
                    listInfoCampaing.des ? listInfoCampaing.des : list_clone_version.description ? list_clone_version.description : ''
                  }

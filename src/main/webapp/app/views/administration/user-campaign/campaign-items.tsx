      ...
      <div className="grid-border" onClick={this.toggle}>
        ...
        <div className="grid-item">
          <div className="camp-top">
            <label className="camp-title"> Chiến dịch M2M thứ {1}</label>
            <label className="camp-status"> Đang hoạt động</label>
          </div>
          <div className="camp-bottom">
            ...
            <div className="camp-bottom-right">
              <div className="camp-bottom-right-top">{200} contacts</div>
              <div className="camp-bottom-right-bot"> 25/7/2019-25/8/2019</div>
            </div>
          </div>

          <Modal isOpen={this.state.modal} fade={false} toggle={this.toggle}>
            <ModalHeader toggle={this.toggle}>
              <span>Chiến dịch M2M thứ 1 </span> <span className="camp-modal-status">Đang hoạt động</span>
            </ModalHeader>
            <ModalBody>
              <div className="modal-grid">
                <div className="modal-grid-child1">
                  ...
                  <div className="modal-grid-child1-bottom">
                    ...
                    <div className="modal-grid-child1-bottom2">{2000}</div>
                    <div className="modal-grid-child1-bottom3">23/8/2019 - 23/9/2019</div>

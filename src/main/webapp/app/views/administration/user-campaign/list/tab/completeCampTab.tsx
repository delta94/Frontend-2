...
export interface ICompleteCampTabProps extends StateProps, DispatchProps {}
// extends StateProps, DispatchProps
export interface ICompleteCampTabState {
  //   listUser: any[];
  loading: boolean;
  modal: boolean;
  activeTab: string;
...
class CompleteCampTab extends React.Component<ICompleteCampTabProps, ICompleteCampTabState> {
  constructor(props) {
    super(props);

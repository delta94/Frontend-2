...
export interface IAllCampTabProps extends StateProps, DispatchProps {}
export interface IAllCampTabState {
  //   listUser: any[];
  loading: boolean;
  modal: boolean;
  activeTab: string;
...
class AllCampTab extends React.Component<IAllCampTabProps, IAllCampTabState> {
  constructor(props) {
    super(props);

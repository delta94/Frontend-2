...
export interface IPauseCampTabProps extends StateProps, DispatchProps {}
// extends StateProps, DispatchProps
export interface IPauseCampTabState {
  //   listUser: any[];
  loading: boolean;
  modal: boolean;
  activeTab: string;
...
class PauseCampTab extends React.Component<IPauseCampTabProps, IPauseCampTabState> {
  constructor(props) {
    super(props);

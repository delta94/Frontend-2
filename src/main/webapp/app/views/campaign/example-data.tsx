...
const treeData = [
  {
    title: <a href="http://localhost:9000/#/app/views/campaign-managament"> tất cả chiến dịch</a>
  },
  {
    title: '`title`',
    subtitle: '`subtitle`',
            ...
            children: [
              {
                ...
                children: [
                  { title: renderDepthTitle },
                  {
                    title: ({ path }) => (path.length >= maxDepth ? 'This cannot be dragged deeper' : 'This can be dragged deeper')
                  }
                ]
              }
            ]

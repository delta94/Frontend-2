...
class DetailForm extends React.Component<any, any> {
  ...
  renderEdgeShapeSelect = () => {
    return (
      <Select onChange={this.handleSubmit}>
        <Option value="custom-edge">Polyline</Option>
  ...
  renderNodeDetail = () => {
    ...
    //         initialValue: model.shape,
    //       })(<Input onBlur={this.handleSubmit} />)}
    //     </Item>
    //     <Item label="Size" {...inlineFormItemLayout}>
    ...
    //       })(<Input onBlur={this.handleSubmit} />)}
    //     </Item>
    //     {model.condition && model.condition.length > 0 ?
    //      <Item label="Condition" {...inlineFormItemLayout}>
  ...
  renderEdgeDetail = () => {
    const { form } = this.props;
    const { label = '', shape = 'custom-edge', condition = '' } = this.item.getModel();
    return (
      <Fragment>
        <Item label="Label" {...inlineFormItemLayout}>
          {form.getFieldDecorator('label', {

...
const avatar1 = require('app/assets/utils/images/avatars/1.jpg');
const avatar8 = require('app/assets/utils/images/avatars/2.jpg');
const avatar3 = require('app/assets/utils/images/avatars/3.jpg');
const avatar4 = require('app/assets/utils/images/avatars/4.jpg');
const avatar5 = require('app/assets/utils/images/avatars/5.jpg');
const avatar6 = require('app/assets/utils/images/avatars/8.jpg');
const avatar7 = require('app/assets/utils/images/avatars/9.jpg');

import { makeData } from "../../../../../../../demo//Tables/DataTables/Examples/utils";
...
export interface IPeopleInfectedProps extends StateProps, DispatchProps { }
export interface IPeopleInfectedStates {
    activeTab: String,
    data: any [];
}
export class PeopleInfected extends React.Component<IPeopleInfectedProps, IPeopleInfectedStates> {
    state : IPeopleInfectedStates = {
        activeTab : "1",
        data : makeData()
    }
...
export default connect(mapStateToProps, mapDispatchToProps)(PeopleInfected);
